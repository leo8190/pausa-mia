...
export const ADDABLE_SOURCES: AddableSourceDefinition[] = [
  ...
  },
  {
    ...
    description: 'Archivo .ics o JSON exportado desde Google Calendar.',
    accept: '.ics,.json',
  ...
  },
  {
    ...
    description: 'Archivo JSON de tu descarga de datos de Instagram.',
    accept: '.json',
  ...
  },
  {
    ...
    description: 'Archivo JSON de tu descarga de información de Facebook.',
    accept: '.json',
  ...
  },
  {
    ...
    description: 'Archivo JSON de tu archivo de datos de X.',
    accept: '.json',
  ...
  },
  {
    ...
    description: 'Archivo JSON o CSV exportado como texto desde LinkedIn.',
    accept: '.json,.csv,.txt',
  ...
  },
  {
    ...
    description: 'Archivo JSON de tu descarga de datos de TikTok.',
    accept: '.json',
