...
| Móvil emulado | macOS arm64 runtime | WebKit + iPhone UA (390×844); Chromium + Android UA (412×915) | N/A no físico | N/A | ✅ síntesis + reproducción WAV | Flujo público completo en ambos perfiles móviles emulados: consentimiento, POST TTS Piper real, reproducción y estado remoto; no sustituye iPhone/Android físicos ni prueba autoplay de hardware | 2026-08-19 | Codex |
